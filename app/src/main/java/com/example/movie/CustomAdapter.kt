...
class MyAdapter(internal var context: Context, private val dataList: List<Athlete>, val clickListener: (Athlete) -> Unit) :
    ...
    inner class CustomViewHolder(val myView: View) : RecyclerView.ViewHolder(myView) {
        ...
        fun click(context: Context, movie: Athlete, clickListener: (Athlete) -> Unit) {
